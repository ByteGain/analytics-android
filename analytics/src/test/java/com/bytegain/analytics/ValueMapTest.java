...
import static com.bytegain.analytics.TestUtils.PROJECT_SETTINGS_JSON_SAMPLE;
  ...
  public void customJsonMapDeserialization() throws Exception {
    ...
    try {
      ...
      assertThat(exception) //
          .hasMessage(
              "Could not create instance of com.bytegain.analytics.ValueMapTest.AmplitudeSettings.\n"
                  + "java.lang.NoSuchMethodException: "
                  + "com.bytegain.analytics.ValueMapTest$AmplitudeSettings.<init>(java.util.Map)");
    }
  }
